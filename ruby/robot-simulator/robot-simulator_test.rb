...
class RobotTurningTest < MiniTest::Test
  ...
  def test_robot_bearing
    directions = [:east, :northeast, :southeast, :north, :northwest, :south, :southwest, :west]
  ...
  def test_turn_right_from_north_east
    robot.orient(:northeast)
    robot.turn_right
    assert_equal :southeast, robot.bearing
  end
  ...
  def test_turn_right_from_south_east
    robot.orient(:southeast)
    robot.turn_right
    assert_equal :southwest, robot.bearing
  end
  ...
  def test_turn_right_from_south_west
    robot.orient(:southwest)
    robot.turn_right
    assert_equal :northwest, robot.bearing
  end
  ...
  def test_turn_right_from_north_west
    robot.orient(:northwest)
    robot.turn_right
    assert_equal :northeast, robot.bearing
  end
  ...
  def test_turn_left_from_north_east
    robot.orient(:northeast)
    robot.turn_left
    assert_equal :northwest, robot.bearing
  end
  ...
  def test_turn_left_from_south_east
    robot.orient(:southeast)
    robot.turn_left
    assert_equal :northeast, robot.bearing
  end
  ...
  def test_turn_left_from_south_west
    robot.orient(:southwest)
    robot.turn_left
    assert_equal :southeast, robot.bearing
  end
  ...
  def test_turn_left_from_north_west
    robot.orient(:northwest)
    robot.turn_left
    assert_equal :southwest, robot.bearing
  end
